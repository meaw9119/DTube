var youtubeUrl = document.getElementById('int'); 
 ...
 function download3(){ 
     var videourl = youtubeUrl.value; 
     sendurl720p(videourl); 
 } 
 function sendurl720p(URL){ 
     window.location.href=`http://localhost:4000/download720p?URL=${URL}`
     }
     
     function download4(){ 
     var videourl = youtubeUrl.value; 
     sendurl1080p(videourl); 
 } 
 function sendurl1080p(URL){ 
     window.location.href=`http://localhost:4000/download1080p?URL=${URL}`
  }
